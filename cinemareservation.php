...
img {
  ...
  <div id ="error">
      ...
      <nav class="navbar navbar-inverse">
          <div class="container-fluid">
              <ol class="nav navbar-nav">
                  ...
                  <li  style="font-size:25px;" class ="active"><a href="cinemareservation.php">Cinema Reservations</a></li>
    ...
    <button type="button" class="collapsible">Reserve a Seat </button>
    <div class="content">
      <br/>
      <iframe src="bookcinemanow.php" style="height:600px;width:100%;border:1px solid black;"></iframe>
    </div>
