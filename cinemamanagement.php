      ...
      <nav class="navbar navbar-inverse">
          <div class="container-fluid">
              ...
              <li style="font-size:25px;"><a href="loggedin.php">Home</a></li>
                  ...
                  <li  style="font-size:25px;"class ="active"><a href="cinemamanagement.php">Cinema Management</a></li>
        ...
        <button  type="button" type="button" class="collapsible">Cinema Types</button>
        <div class="content">
        <h1><strong>Cinema Types</strong></h1>
          <?php 
        ...
        <button type="button" class="collapsible">Seat No.(s)</button>
        <div class="content">
        <?php
                $connect = mysqli_connect(DB_SERVER , DB_USER, DB_PASSWORD, DB_DATABASE);
                ...
                if($connect->connect_error)
                {
                  ...
                  if($result = mysqli_query($connect,$sql))
                  {
                    ...
                    echo "
                    <table class='table'>
                    <tr><br/><h1><strong>Seat No.(s)</strong></h1></tr>
                    <tr>
                    <th>Seat No</th>
                    <th>Type code</th>
                    </tr>";
        ...
        <button type="button" class="collapsible">Check Available Seats</button>
        <div class="content">
            <form method ="post">
              ...
              if($_POST['submit'])
              {
                  if(array_key_exists('start',$_POST))
                  {
                      ...
                      if($result = mysqli_query($connect,$sql))
                      {
                          echo "
                              <table class ='table'>
                              <tr><br/><h1><strong>Available Seats</strong></h1></tr>
                              <tr>
                              <th>Seat No </th>
                              <th>Type ID</th>
                              </tr>";
              ...
              if($_POST['submit'])
              {
                  if(array_key_exists('start',$_POST))
                  {
                      ...
                      if($result = mysqli_query($connect,$sql))
                      {
                          echo "
                              <table class ='table'>
                              <tr><br/><h1><strong>No. of Available Seat(s)</strong></h1></tr>
                              <tr>
                              <th>Seat No </th>
                              <th>Type ID</th>
                              </tr>";
        ...
        <button class="collapsible">Update Seat Status</button>
        <div class="content">
          <form method ="post">
              <h1><strong>Select date</strong></h1>
              <h3>Enter Date</h3>
              <input type="date" id="moviedate" name="moviedate" min="<?php echo date("Y-m-d");?>" max="2020-12-31">                                    <br>
              <br>
              <input  type ="submit" name="cinemabook" value="update" >
          </form>
          <div class="col-sm-6" style="background-color:LightSteelBlue;">

          <?php
          if(isset($_POST['cinemabook']))
          {
            if($_POST['cinemabook'])
            {
              if(array_key_exists('moviedate',$_POST) )
              {
                  $connect = mysqli_connect(DB_SERVER , DB_USER, DB_PASSWORD, DB_DATABASE);
                  ...
                  $query =  "Delete from cinemastatus where date = '".$date."' ;";
                  if ($connect->query($query) == TRUE)
                  {
                      print("<script>window.alert('Seat Status Updated !');</script>");
                  }
                  else
                  {
                      print("<script>window.alert('Error:exist');</script>");
                  }
                  mysqli_close($connect);
              }
            }
