      ...
      <nav class="navbar navbar-inverse">
          <div class="container-fluid">
              <ol class="nav navbar-nav">
                  ...
                  <li  style="font-size:25px;" class ="active" ><a href="bills.php">Customer invoice</a></li>
...
if(isset($_POST['name']))
{
    if(array_key_exists('name',$_POST))
    {
        ...
        $check=0;
        $bookid=$_POST['name'];
        $sql ="SELECT * FROM `roombills` where bookid = '$bookid';";
        ...
        while($row = mysqli_fetch_array($result))
        {
          ...
          echo 
          '
          <tr><td> Bill ID    : '.$row[0].'</td></tr>
          <br/>
          <tr><td> Booking ID : '.$row[1].'</td></tr>
          <br/>
          <tr><td> Facilities : '.$row[2].'</td></tr>
          <br/>
          <tr><td> Price      : '.$row[3].'</td></tr>
          <br/>
          <tr><td> Total Price: '.$row[4].'</td></tr>';
        }
        echo "</table>";
        $check=1;
        }
