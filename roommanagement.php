      ...
      <nav class="navbar navbar-inverse">
          <div class="container-fluid">
              ...
              <li style="font-size:25px;"><a href="loggedin.php">Home</a></li>
                  ...
                  <li style="font-size:25px;" class ="active"><a href="roommanagement.php">Room Management</a></li>
        ...
        <div class="content">
        <h1><strong>Room Types</strong></h1>
          <?php 
        ...
        <button type="button" class="collapsible">Room No.(s)</button>
        <div class="content">
        <?php
                $connect = mysqli_connect(DB_SERVER , DB_USER, DB_PASSWORD, DB_DATABASE);
                ...
                if($connect->connect_error)
                {
                  ...
                  if($result = mysqli_query($connect,$sql))
                  {
                    ...
                    echo "
                    <table class='table'>
                    <tr><br/><h1><strong>Room No.(s)</strong></h1></tr>
                    <tr>
                    <th>Room No</th>
                    <th>Type code</th>
                    </tr>";
