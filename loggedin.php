      ...
      <nav class="navbar navbar-inverse">
          <div class="container-fluid">
              <ol class="nav navbar-nav">
                  <li style="font-size:25px;" class ="active"><a href="loggedin.php">Home</a></li>
            ...
            <div class="col-sm-9" style="background-color:lavenderblush;"><h1 style='text-align:center;'><strong>Welcome "<?php echo $_SESSION['name'] ?>" To Admin Portal</h1></strong></div>
