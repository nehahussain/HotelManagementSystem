...
if(isset($_POST['submit']))
{
    ...
    {
        if(array_key_exists('name',$_POST) and array_key_exists('phone',$_POST) and array_key_exists('email',$_POST)and array_key_exists('message',$_POST))
        {
            ...
            $cid=uniqid();
            $query =  "INSERT INTO `contact` (`cid`, `name`, `phone`, `email`, `message`) VALUES ('$cid', '$name', '$phone', '$email', '$message');";
            if ($connect->query($query) == TRUE)
            {
              print("<script>window.alert('Your Message has been sent to the management');</script>");
            }
            else
            {
              echo $connect->error;
              print("<script>window.alert('Error: sending message');</script>");
            }
            require_once 'mailer/class.phpmailer.php'; 
                            $mail = new PHPMailer(true);
                            $email      = $email;
                            $subject    = "***Message sent ot the management***";
                            $text_message    = "";      
                            $message  ="Contact ID: $cid <br/>
                            email : $email <br/>
                            phone no: $phone <br/>
                            Message:$message<br/>" ;
                          try
                            {
                              ...
                              if($mail->Send())
                              {
                                print("<script>window.alert('message sent');</script>");
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="eventbooking.php">Event Reservation</a></li>                        <li><a href="restaurant.html">Restaurant</a></li>
